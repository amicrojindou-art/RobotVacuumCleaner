...
def import_env(env_name_str):
    ...
    elif env_name_str=='vacuum':
        from envs.vacuum import VacuumEnv as Env
    elif env_name_str=='vacuum_wf':
        from envs.vacuum import VacuumWFEnv as Env
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--target_kl", required=False, default=None, type=float, help="KL divergence threshold for early stopping (e.g. 0.04)")
    parser.add_argument("--lr_decay", required=False, action="store_true", help="linearly decay learning rate over n_itr")
